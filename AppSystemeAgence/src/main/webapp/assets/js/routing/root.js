...
monApp.config(function($routeProvider) {
	...
	$routeProvider
	.when("/accueilU",{templateUrl:"views/accueilU.html",controller:"accueilUCtrl"})
	...
	.when("/coConseiller",{templateUrl:"views/login_conseiller.html",controller:"ConnexionConseillerCtrl"})
	.otherwise({
		redirectTo:"/accueilU"
	})
});